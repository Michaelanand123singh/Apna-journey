        ...
        <div className="relative container mx-auto px-3 sm:px-4 lg:px-6 py-6 sm:py-8 lg:py-12">
          <div className="max-w-4xl">
            <div className="flex items-center space-x-2 sm:space-x-3 lg:space-x-4 mb-4 sm:mb-6">
              <div className="p-2 sm:p-2.5 lg:p-3 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-lg sm:rounded-xl shadow-lg">
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                <div className="bg-gradient-to-r from-slate-50 to-slate-100 px-4 sm:px-6 py-3 sm:py-4 border-b border-slate-200">
                  <h2 className="text-base sm:text-lg font-semibold text-slate-900 flex items-center">
                    <Search className="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3 text-slate-600" />
                    Refine Search
                  </h2>
                </div>
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
              <div className="bg-gradient-to-r from-slate-50 to-slate-100 px-4 sm:px-6 py-3 sm:py-4 border-b border-slate-200">
                <div className="flex items-center justify-between">
                  <h2 className="text-base sm:text-lg font-semibold text-slate-900">Job Listings</h2>
                  <div className="flex items-center space-x-2 text-xs sm:text-sm text-slate-600">
                    <span className="px-2 sm:px-3 py-1 bg-slate-100 rounded-full">Latest First</span>
                  </div>
                </div>
              </div>
              <div className="p-4 sm:p-6">
