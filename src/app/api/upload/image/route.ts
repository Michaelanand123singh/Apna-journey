...
export async function POST(request: NextRequest) {
  try {
    ...
    const folder = formData.get('folder') as string || 'apna-journey/news'
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const uploadResult = await cloudinaryService.uploadFromUrl(imageUrl, folder || 'apna-journey/news')
