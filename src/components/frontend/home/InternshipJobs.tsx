...
import { GraduationCap, MapPin, Clock, ArrowRight, Award } from 'lucide-react'
    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4">
        <div className="flex-1">
          ...
          <p className="text-xs text-gray-600 pl-7">Latest internship opportunities</p>
        </div>
        <Link
      ...
      {jobs.length === 0 ? (
        <div className="text-center py-12 bg-gray-50 rounded-xl">
          ...
          <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2">No Internships</h3>
