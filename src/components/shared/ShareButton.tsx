...
export default function ShareButton({ 
  ...
  const fullDescription = description || (type === 'job' ? 'India-first platform with nationwide job opportunities' : 'Latest news from India')

  const shareLinks = {
    facebook: `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(url)}`,
    twitter: `https://twitter.com/intent/tweet?url=${encodeURIComponent(url)}&text=${encodeURIComponent(shareText)}&hashtags=IndiaFirst,Jobs,News`,
